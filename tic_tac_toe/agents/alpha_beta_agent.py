...
class AlphaBetaAgent(Agent):
    ...
    def _minimax(self, board, player, depth=None, alpha=(-math.inf,0), beta=(math.inf,0), pruned=[False]):
        ...
        for next_move in moves:
            ...
            value = self._minimax_move(next_move, board, other_player(player), depth+1, (-beta[0],-beta[1]), (-alpha[0],-alpha[1]), child_pruned)
